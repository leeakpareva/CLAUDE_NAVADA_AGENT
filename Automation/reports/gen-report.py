...
data = json.load(open(r'C:\\Users\\leeak\\Alex\\Automation\\reports\\report-data-2026-03-01.json', 'r'))
news = data['news']
...
pdf.output(r'C:\\Users\\leeak\\Alex\\Automation\\reports\\weekly-report-2026-03-01.pdf')
print('PDF generated')
